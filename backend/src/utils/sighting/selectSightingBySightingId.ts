...
export const selectSightingBySightingId = async (sightingId: string) => {
	...
	const mySqlQuery = 'select bin_to_uuid(sightingId) as sightingId, sightingCity, sightingSummary, sightingDateTime from sighting where sightingId = uuid_to_bin(:sightingId)'
